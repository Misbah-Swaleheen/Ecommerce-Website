	...
	<div class="card card-authentication1 mb-0">
		<div class="card-body">
		 <div class="card-content p-2">
          ...
          <?php 
                if (isset($_POST['btn1'])) {
                    $user= $obj->fetchsignup(); 
                    if($user){
                        ?>
                        <span style="color:red">User is already exist</span>
                    <?php 
                    }
                    else{
                        $obj->insert(); 
            ...
            ?>
              ...
              <div class="form-group">
			   ...
			   <div class="position-relative has-icon-right">
				  <input type="password" name="cpassword" id="exampleInputPassword" class="form-control input-shadow" placeholder="confirm Password">
				  <div class="form-control-position">
					  <i class="icon-lock"></i>
				  </div>
			   </div>
              ...
              <div class="form-group">
			   <label for="exampleInputPassword" class="sr-only">Profile picture</label>
			   <div class="position-relative has-icon-right">
				  <input type="file" name="img" id="exampleInputPassword" class="form-control input-shadow" placeholder="confirm Password">
				  <div class="form-control-position">
			 ...
			 <button type="submit" name="btn1" class="btn btn-light btn-block waves-effect waves-light">Sign Up</button>
