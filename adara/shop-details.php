        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="shop-details-flex-wrap">
                    <div class="shop-details-nav-wrap">
                        ...
                        ?>
                            <li class="nav-item " role="presentation">
                                <a class="nav-link <?php echo ($match == $key )? 'active': ''?>" data-toggle="tab" href="#img<?php echo $key?>" ><img src="<?php echo '../aadmin panel/assets/images/products/'.$image?>" alt=""></a>
                            </li>
                            <?php 
                             } 
                            ?>
                    ...
                    <div class="shop-details-img-wrap">
                        ...
                        ?>
                            <div class="tab-pane fade <?php echo ($match == $key )? 'active show': ''?>" id="img<?php echo $key?>" >
                                <div class="shop-details-img">
                                    <img src="<?php echo '../aadmin panel/assets/images/products/'.$image?>" alt="">
                                </div>
                            </div>
                            <?php 
            ...
            <div class="col-lg-5">
                <div class="shop-details-content">
                    ...
                    <div class="price">Price : PKR <?php 
                        echo  number_format($data['p_sale_price'])
                    ?></div>
                    ...
                    <div class="perched-info">
                        ...
                        <a href="addtocart.php?pid=<?php echo $data['id'] ?>" class="btn">add to cart</a>
